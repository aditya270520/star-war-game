...
window.title("Star Wars Game by ADITYA BHUSHAN SHARMA")
...
for _ in range(5):   
    ...
    chattan.fd(distance)
    chattan.setheading(ADITYA1(player, chattan))
...
window.mainloop()
#This Game is build by Aditya Bhushan Sharma
